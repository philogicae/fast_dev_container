...
_fdevc_gen() {
    ...
    echo -e "  ${_c_dim}├── install_and_run${_c_reset}"
    echo -e "  ${_c_dim}├── launch.sh${_c_reset}"
    echo -e "  ${_c_dim}└── fdevc_setup/${_c_reset}"
    echo -e "  ${_c_dim}    └── runnable.sh${_c_reset}"
    echo ""
    ...
    echo -e "  ${_c_bold}2.${_c_reset} Edit ${_c_bold}fdevc_setup/runnable.sh${_c_reset} to add your setup commands"
